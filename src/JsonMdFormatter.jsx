    ...
    <>
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        <div className="mb-6">
          ...
          {fileName && (
            <p className="mt-2 text-sm text-gray-500">Current file: {fileName}</p>
          )}
        </div>
      ...
      {hasDocument && Object.keys(prompts).length === 0 && (
        <div className="bg-white rounded-lg shadow-md p-12 text-center">
          <p className="text-gray-500 text-lg">No keys yet. Click &quot;Add New Key&quot; to get started.</p>
        </div>
      )}
    </>
  )
...
export default JsonMdFormatter
